$(document).ready(function(){
   ...
   function requests(queryURLW, queryURLF){
       ...
       $.ajax({
           ...
           $.ajax({
               ...
               // Functions to check if the ajax failed.
               }).fail(function(){
   ...
   // Function to set the Id of search buttons, to check if ther are saved searches and to continue id naming from last saved.
   ...
   function displayWeather(response) {
       ...
       for (i, e = 1; i < 40; i + 8, e++) {
           ...
           i = i + 8; // This skips from one day to the next.
       }
   }
